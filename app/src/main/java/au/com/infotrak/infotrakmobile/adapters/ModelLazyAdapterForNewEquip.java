...
/**
 * Created by Nouman on 18/03/2015.
 */
public class ModelLazyAdapterForNewEquip extends ArrayAdapter<Model> {
    // Your sent context
    ...
    public ModelLazyAdapterForNewEquip(Context context, int textViewResourceId,
