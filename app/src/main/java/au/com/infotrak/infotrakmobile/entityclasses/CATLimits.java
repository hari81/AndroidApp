...
public class CATLimits {
    ...
    public CATLimits(long compartIdAuto, String catTool, int slope, double adjToBase, double hiInflectionPoint, double hiSlope1, double hiIntercept1, double hiSlope2, double hiIntercept2, double miInflectionPoint,
