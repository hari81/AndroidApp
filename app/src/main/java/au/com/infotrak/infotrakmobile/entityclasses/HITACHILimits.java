...
public class HITACHILimits {
    ...
    public HITACHILimits(){}

    public HITACHILimits(long compartIdAuto, String hitTool, double impactSlope, double impactIntercept, double normalSlope, double normalIntercept)
    {
