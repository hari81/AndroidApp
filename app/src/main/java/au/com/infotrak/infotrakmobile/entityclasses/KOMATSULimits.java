...
public class KOMATSULimits {
    ...
    public KOMATSULimits(){}

    public KOMATSULimits(long compartIdAuto, String komTool,double impactSecondOrder, double impactSlope, double impactIntercept,double normalSecondOrder, double normalSlope, double normalIntercept)
    {
