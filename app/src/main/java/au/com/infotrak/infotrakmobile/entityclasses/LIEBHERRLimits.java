...
public class LIEBHERRLimits {
    ...
    public LIEBHERRLimits(){}

    public LIEBHERRLimits(long compartIdAuto, String lieTool, double impactSlope, double impactIntercept, double normalSlope, double normalIntercept)
    {
