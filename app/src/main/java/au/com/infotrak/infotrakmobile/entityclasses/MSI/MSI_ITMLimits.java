...
public class MSI_ITMLimits {
    ...
    public MSI_ITMLimits(long compartIdAuto, long CompartMeasurePointId, String itmTool, double startDepthNew, double wearDepth10Percent, double wearDepth20Percent, double wearDepth30Percent, double wearDepth40Percent, double wearDepth50Percent,
