...
public class WRESITMLimits {
    ...
    public WRESITMLimits(long compartIdAuto, String itmTool, double startDepthNew, double wearDepth10Percent, double wearDepth20Percent, double wearDepth30Percent, double wearDepth40Percent, double wearDepth50Percent,
